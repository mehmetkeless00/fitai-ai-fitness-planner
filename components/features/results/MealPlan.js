...
export default function MealPlan({ plan }) {
  ...
  if (!plan || !plan.mealPlan) {
    return <div className="text-center text-slate-400 py-8">Loading meal plan...</div>;
  }
                      ...
                      <div className="bg-dark-bg/50 rounded p-2 space-y-1">
                        ...
                        <div className="w-full bg-dark-border rounded-full h-1 overflow-hidden flex gap-0.5">
                          <div
                            ...
                            style={{
                              width: `${(meal.macros.protein / (meal.macros.protein + meal.macros.carbs + meal.macros.fat)) * 100}%`,
                            }}
                          />
                          <div
                            className="bg-yellow-500"
                            style={{
                              width: `${(meal.macros.carbs / (meal.macros.protein + meal.macros.carbs + meal.macros.fat)) * 100}%`,
                            }}
                          />
                          <div
                            className="bg-green-500"
                            style={{
                              width: `${(meal.macros.fat / (meal.macros.protein + meal.macros.carbs + meal.macros.fat)) * 100}%`,
                            }}
                          />
                        </div>
                      </div>
