// Single seam for all plan persistence. Nothing else in the app may touch
// localStorage for plans — this keeps a future move to cloud storage (or
// AsyncStorage in React Native) contained to this one module.
